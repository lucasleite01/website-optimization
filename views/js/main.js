...
var resizePizzas = function(size) {
  ...
  function changePizzaSizes(size) {
    // O vetor retornado por document.querySelectorAll(".randomPizzaContainer")
    // estava sendo buscado várias vezes dentro do for sem necessidade, por isso
    // coloquei ele do lado de fora do for
    var randomPizzaContainer = document.querySelectorAll(".randomPizzaContainer");
    // dx e newwidth são iguais para todos os randomPizzaContainer's, portanto basta
    // pegar o valor dx do primeiro, e calcular o newwidth do primeiro, e depois
    // replicar para os outros
    var dx = determineDx(document.querySelector(".randomPizzaContainer"), size);
    var newwidth = (document.querySelector(".randomPizzaContainer").offsetWidth + dx) + 'px';

    for (var i = 0; i < randomPizzaContainer.length; i++) {
      //Agora basta utilizar o vetor randomPizzaContainer para modificar as larguras
...
// Nessa função, diminuí o número de fatias de pizza geradas de 200 para 25
// fazendo com que a renderização seja mais rápida e conseguisse rodar a 60 fps
